...
const SignUp = () => {
  ...
  return (
    <>
      ...
      <form className="absolute flex flex-col gap-3 w-[23rem] py-10 px-6 rounded-lg bg-black top-32 left-[40%] text-white bg-opacity-85">
...
{ !isSignIn  && <input type='text' placeholder='Enter your Full Name' className="w-full p-4  rounded-md bg-gray-800" />
        ...
        <input type='email' placeholder='Enter your email' className="w-full p-4  rounded-md bg-gray-800" />
        <input type='password' placeholder='Enter your password' className="w-full p-4   rounded-md bg-gray-800" />
        <button className="w-full p-4   rounded-md bg-red-600 font-bold">{isSignIn ? 'Sign in' : 'Sign Up'}</button>
